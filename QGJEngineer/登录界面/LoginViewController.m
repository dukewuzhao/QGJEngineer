...
-(void)updateversionDic:(NSString *)NewVersion{
    ...
    NSDictionary *NewDic = [NSDictionary dictionaryWithObjectsAndKeys:verDic[@"version"],@"version",verDic[@"key1"],@"key1", verDic[@"key2"],@"key2",verDic[@"key3"],@"key3",verDic[@"key4"],@"key4",NewVersion,@"firmversion",nil];
